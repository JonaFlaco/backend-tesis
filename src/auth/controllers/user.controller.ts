...
export class UsersController {
  ...
  @Post('create-with-record')
  async createUserWithRecord(
    @Body() payload: CreateUserDto,
    @Body('personalDocumentsId') personalDocumentsId: string,
    @Body('inscriptionFormId') inscriptionFormId: string,
    @Body('degreeId') degreeId: string,
  ) {
    return this.usersService.createUserWithRecord(
      payload,
      personalDocumentsId,
      inscriptionFormId,
      degreeId,
